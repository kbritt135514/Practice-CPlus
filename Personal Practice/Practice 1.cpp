...
float cashierPay = 13.00;
float floorPay = 15.50;
float storagePay = 14.00;
double fittingPay = 15.50;
float managerPay = 25.50;
...
int main() {
    ...
    string names[workerNumber];
    string job[workerNumber];
    float employeePayout[workerNumber];
